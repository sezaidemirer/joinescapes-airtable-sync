      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 sm:h-22 md:h-24 lg:h-28">
          ...
          <div className="flex items-center space-x-4 lg:space-x-6 ml-auto mr-4">
            ...
            <nav className="flex space-x-6 lg:space-x-8" role="navigation" aria-label="Ana navigasyon">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}
            ...
            {loading ? (
              ...
              <div className="flex items-center space-x-1 lg:space-x-2">
                ...
                {(() => {
                  ...
                  } else if (userRole === 'editor' || userRole === 'yazar') {
          ...
          <div className="md:hidden" id="mobile-menu">
            <nav className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t" role="navigation" aria-label="Mobil navigasyon">
              ...
              {!loading && !isAuthenticated && (
                <Link
                  to="/kullanici-girisi"
                  className="block mt-2 px-3 py-2 rounded-md text-sm font-medium text-white bg-primary-600 hover:bg-primary-700"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Giriş Yap
                </Link>
