  ...
  const fetchMainPageData = async () => {
    ...
    try {
      ...
      if (writers && writers.length > 0) {
        ...
        console.log('✅ Öne çıkan yazarlar yüklendi:', writers.length)
      } else {
      ...
      >
          ...
          <Link
            ...
            <div className="col-span-1 lg:col-span-1">
              <div className="h-64 sm:h-80 lg:h-[500px] flex flex-col gap-2 sm:gap-4">
                    ...
                    {loading ? (
                      ...
                      <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                        {mostReadNews.map((news, index) => (
                          <div 
                            key={news.id} 
                            className="p-1.5 sm:p-2 border-b border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors"
                          >
                          {news.category_slug && news.slug ? (
                            <Link 
                              ...
                              className="block"
                            >
                              <h4 className="text-xs sm:text-sm font-medium text-gray-900 leading-tight hover:text-primary-600 transition-colors">
                                {news.title}
                              </h4>
                            </Link>
                          ) : (
                      ...
                      <div className="p-4 sm:p-6 text-center text-gray-500">
                        ...
                        <div className="text-xs sm:text-sm mt-1 sm:mt-2">"En Çok Okunan" etiketli haber ekleyin</div>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex-[1.2] flex flex-col">
                  ...
                  <div className="bg-white rounded-b-lg shadow-lg p-4 sm:p-6" style={{ height: 'calc(100% - 60px)' }}>
                    <a 
                      href="https://www.prontotour.com/Super-Promosyon"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block"
                    >
                      <div 
                        className="adsense-sidebar relative overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer"
                        data-ad-client="ca-pub-9097929594228195"
                      ...
                      >
                        <img 
                          src="/images/pronto_reklam_2.webp" 
                          alt="Prontotour Süper Promosyon - Tıklayın"
      ...
      <section className="py-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-start gap-2 sm:gap-3">
            {featuredWriters.length > 0 ? (
              featuredWriters.map((writer) => {
                ...
                const slug = writer.name?.toLowerCase()
                  .replace(/ğ/g, 'g')
                  .replace(/ü/g, 'u')
                  .replace(/ş/g, 's')
                  .replace(/ı/g, 'i')
                ...
                return (
                  ...
                  >
                    <div className="relative mb-1">
                      <img 
                        src={writer.profile_image || 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80'} 
                        alt={writer.name}
                        className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full object-cover mx-auto shadow-md ring-2 ring-white group-hover:ring-primary-200 transition-all duration-300 group-hover:scale-105"
                      />
                      <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 sm:w-5 sm:h-5 bg-green-500 rounded-full border-2 border-white"></div>
                    </div>
                    <h3 className="font-semibold text-gray-900 text-sm mb-0 group-hover:text-primary-600 transition-colors">
                      {writer.name}
                    </h3>
                    <p className="text-sm text-gray-600">{writer.title || 'Yazar'}</p>
                  </Link>
                )
              })
            ) : (
              // Fallback: Eğer hiç öne çıkan yazar yoksa placeholder göster
          ...
          <div className="text-center mt-4 px-4 sm:px-0">
            <Link 
              to="/yazarlar"
              className="inline-flex items-center px-4 py-2.5 sm:px-6 sm:py-3 border border-transparent rounded-lg shadow-sm text-xs sm:text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 transition-colors duration-200"
            >
          ...
          <div className="flex justify-center items-center min-h-[300px]">
            ...
            <div className="text-center text-white max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a 
                  href="https://www.prontotour.com/Avrupa-Turlari"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://www.prontotour.com/Vizesiz-Turlar"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative bg-gradient-to-r from-blue-500 to-blue-700 text-white px-10 py-4 rounded-full font-semibold text-lg overflow-hidden transition-all duration-300 hover:from-blue-600 hover:to-blue-800 hover:shadow-2xl hover:-translate-y-1 inline-block text-center"
                >
